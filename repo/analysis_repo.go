...
func (r *AnalysisRepo) GetMoveByOrder(moveOrder int, gameID, userID string) (models.Move, error) {
	var move models.Move
	err := r.db.QueryRow(pg_sql.GetMoveByOrder, gameID, moveOrder, userID).Scan(&move.Move, &move.Fen)
	if err != nil {
